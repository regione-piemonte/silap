...
public abstract class ProvinciaMapper implements BaseMapperInterface<Provincia,SilapDProvincia> {

	public abstract Provincia toModel(SilapDProvincia entity);
