...
import it.csi.silap.colmirbff.api.impl.manager.CsiLogAuditManager;
import it.csi.silap.colmirbff.api.impl.manager.SilapDOperatoreManager;
...
import it.csi.silap.colmirbff.util.JsonUtils;
import it.csi.silap.colmirbff.util.ResponseUtils;
...
public class AuditingInterceptor implements Serializable {
	...
	@Inject
	private SilapDOperatoreManager silapDOperatoreManager;
	...
	public Object logExecution(InvocationContext invocationContext) throws Exception {
		...
		silapDOperatoreManager.traceOperatore(getOperatore());
